...
class TransformerLanguageModelConfig(FairseqDataclass):
    ...
    desynchronize: Optional[bool] = field(
        default=False,
        metadata={
            "help": "desynchronize gradients between GPUs"
        }
    )
    ...
    sync_type: Optional[str] = field(
        default=None,
        metadata={
            "help": "specify synchronization type (one of none, random, or manual)"
        }
    )

    data_parallel_groups: Optional[str] = field(
        default=None,
        metadata={
            "help": "specify the rank groupings that you want to all reduce over. e.g. 1,2,3 4 5"
        }
    )

    untie_parameters: Optional[str] = field(
        default=None,
        metadata={
            "help": "parameters you'd like to untie."
        }
    )
    
    adaptation: bool = field(
        default=False,
        metadata={
    ...
    params_to_freeze: str = field(
        default="",
        metadata={
            "help": "comma separated list of partial or full names of parameters to set requires_grad=False"
        }
    )
    ...
    moe_expert_decoder_ffn_dim: Optional[int] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_alpha: Optional[int] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_num_experts_per_domain: Optional[int] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_num_domains: Optional[int] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_domain_expert: Optional[bool] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_hierarchical_expert: Optional[bool] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    use_experts_during_training: Optional[bool] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_num_experts_per_gpu: Optional[int] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_num_shared_experts: Optional[int] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    )
    moe_expert_type: Optional[str] = field(
        default=None,
        metadata={
            "help": "MoE expert FFN dimension"
        }
    ...
    add_expert_layers: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Use top1 gate instead of top2"
        }
    ...
    add_expert_ffn: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Add expert FFN"
        }
...
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.moe_freq > 0 and (getattr(args, 'fp16', False) and not getattr(args, 'memory_efficient_fp16', False)):
...
def base_lm_architecture(args):
    ...
    args.add_expert_layers = getattr(args, "add_expert_layers", False)
    args.add_expert_ffn = getattr(args, "add_expert_ffn", False)
