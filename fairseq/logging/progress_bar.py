...
def progress_bar(
    ...
    if log_format == "json":
        ...
        bar = TqdmProgressBar(iterator, epoch, prefix, level)
    else:
    ...
    if wandb_project:
        bar = WandBProgressBarWrapper(bar, wandb_project, run_name=wandb_run_name, entity=wandb_entity)
...
class TqdmProgressBar(BaseProgressBar):
    ...
    def __init__(self, iterable, epoch=None, prefix=None, level=0):
        super().__init__(iterable, epoch, prefix)
...
class WandBProgressBarWrapper(BaseProgressBar):
    ...
    def __init__(self, wrapped_bar, wandb_project, run_name=None, entity=None):
        super().__init__(wrapped_bar.iterable)
        self.wrapped_bar = wrapped_bar
        if wandb is None:
        ...
        wandb.init(settings=wandb.Settings(start_method='fork'), project=wandb_project, reinit=False, name=run_name, entity=entity)
