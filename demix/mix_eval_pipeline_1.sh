...
prior_results_path=${output_dir}/${evals_folder}/${target_domain}/dev_posteriors.jsonl;
results_path=${output_dir}/${evals_folder}/${target_domain}/test_results.txt;

mkdir -p ${output_dir}/${evals_folder}/${target_domain};
cd $MOD_FOLDER;
# echo $results_path;
echo $model;
# echo $MOD_FOLDER;
