#!/bin/bash
#SBATCH --job-name=demix-gpt3-medium
...
#SBATCH --output=/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints2/stdout
#SBATCH --error=/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints2/stderr
...
export SERIALIZATION_DIR=/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints2
