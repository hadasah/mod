...
SWEEP_NAME = "eval_dense_108000_to_modular"
DEBUG_MODE = False
name_keys = []
NUM_GPUS = 8
...
MODEL_FOLDER = '/gscratch/zlab/margsli/demix-checkpoints/models/_dense_108000_to_modular_redo'
MODEL_FOLDER_PREFIX = 'dense_108000_to_modular_DOMAINID='
