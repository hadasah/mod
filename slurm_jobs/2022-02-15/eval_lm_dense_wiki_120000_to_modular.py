...
SWEEP_NAME = "eval_dense_wiki_120000_to_modular"
DEBUG_MODE = False
name_keys = []
NUM_GPUS = 8
...
MODEL_FOLDER_PREFIX = 'wikipedia_to_domains_with_checkpoints_DOMAIN='
CHECKPOINT_IDS = '3_138000,1_90000,1_78000,1_126000,1_126000,1_90000,1_102000,1_66000'
...
grids = {
    SWEEP_NAME: {
        ...
        'positional_args': {
            ...
            "DOMAIN": ['anonymized_latest_news_redo', 'legal_contracts', 'gutenberg', '1b', 'anonymized_openwebtext', 'anonymized_realnews', 'anonymized_reviews', 'cs', 'legal', 'med', 'reddit'], 
