...
SWEEP_NAME = "demix_medium_24000_to_modular"
NUM_GPUS = 1
DEBUG_MODE = False
name_keys = []
...
grids = {
    SWEEP_NAME: {
        ...
        'positional_args': {
            ...
            "INIT_MODEL_FOLDER": ["/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints/demix_8_GPUs_transformer_lm_gpt3_medium_tutorial"],
            "CKPT": [24000],
