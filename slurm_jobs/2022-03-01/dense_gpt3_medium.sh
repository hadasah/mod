...
#SBATCH --output=/gscratch/zlab/margsli/demix-checkpoints/models/dense_gpt3_medium_with_checkpoints3/stdout
#SBATCH --error=/gscratch/zlab/margsli/demix-checkpoints/models/dense_gpt3_medium_with_checkpoints3/stderr
...
export SERIALIZATION_DIR=/gscratch/zlab/margsli/demix-checkpoints/models/dense_gpt3_medium_with_checkpoints3
