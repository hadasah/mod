...
SWEEP_NAME = "eval_dense_72000_to_modular_fixed_update_exclude_expert_add_generalist"
DEBUG_MODE = False
DRY_MODE = False
name_keys = []
NUM_GPUS = 8
...
grids = {
    SWEEP_NAME: {
        ...
        'positional_args': {
            ...
            "TOP_K": [8],
            "ID": ["fixed_update_exclude_expt_add_generalist"],
            "EXCLUDE_DOMAIN_EXPERT": ["True"]
        },
        'named_args': {},
    },
}
