...
SWEEP_NAME = "eval_dense_36000_to_modular"
DEBUG_MODE = False
name_keys = []
NUM_GPUS = 8
...
MODEL_FOLDER = '/gscratch/zlab/margsli/demix-checkpoints/models/_dense_36000_to_modular'
MODEL_FOLDER_PREFIX = 'dense_36000_to_modular_DOMAINID='
