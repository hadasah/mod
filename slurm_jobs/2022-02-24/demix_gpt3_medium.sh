...
#SBATCH --output=/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints/stdout
#SBATCH --error=/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints/stderr
...
export SERIALIZATION_DIR=/gscratch/zlab/margsli/demix-checkpoints/models/demix_gpt3_medium_with_checkpoints
