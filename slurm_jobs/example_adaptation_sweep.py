...
def main(model, debug=False, dry_mode=False, from_scratch=False, domains=None, load_from_step=-1):
    DEBUG_MODE = debug
    DRY_MODE = dry_mode
    ...
    SWEEP_NAME = f"sweep_{MODEL}_adaptation"
    ...
    PATH_TO_DENSE_CHECKPOINTS = f'/checkpoint/suching/mod/_modular_gpt3_small_80K/modular_gpt3_small_80K_LR\=0.0005/MODEL=transformerlmgpt3small_DOMAINID=3_LOADFROMSTEP=24000_RESETITEMS=dataloader_UPDATEFREQ=32_LR=0.0005/'
